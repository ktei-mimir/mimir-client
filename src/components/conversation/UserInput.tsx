const UserInput = () => {
  return (
    <div
      className="absolute bottom-0 left-0 w-full border-t md:border-t-0 
      ...
      <form className="stretch ml-2 md:mx-4 flex flex-row gap-3 last:mb-2 md:max-w-5xl w-full">
        ...
        <div className="flex items-center md:px-3 py-2 w-full">
          <textarea
            ...
            className="block mx-4 p-2.5 w-full md:max-h-36 text-sm text-gray-900 bg-white resize-none md:resize-y
